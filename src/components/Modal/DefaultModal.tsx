  ...
  return ReactDOM.createPortal(
    <Fragment>
      {isOpen && (
        <div
          onClick={closeModal}
          className="fixed left-0 top-0 z-[50] grid h-[100vh] w-screen place-items-center bg-black/80 px-[5%] text-white backdrop-blur-lg"
        >
          <div
            onClick={(e) => e.stopPropagation()}
            className="relative z-[50] grid min-h-[300px] w-full max-w-[500px] place-items-center gap-6 rounded-3xl border border-white bg-gradient-to-br from-[#FFFFFF1A] to-black p-5 text-center font-montserrat shadow-md backdrop-blur-md"
          >
            {Image}
